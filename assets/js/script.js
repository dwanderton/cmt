...
jQuery('#upload_listing_image_button').on( 'click', function( event ) {
		event.preventDefault();
		console.log("upload_listing_image_button clicked");

		jQuery.fn.upload_listing_image( jQuery(this) );
	});
	jQuery('#remove_listing_image_button').on( 'click', function( event ) {
		event.preventDefault();
		console.log("remove_listing_image_button clicked");
